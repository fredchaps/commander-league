    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        <div class="relative pt-36 ml-auto">
            <div class="lg:w-2/3 text-center mx-auto">
                <h1 class="text-surface-900 dark:text-primary-400 text-8xl xl:text-9xl unstyled theme-heading">Commander League</h1>
                <p class="mt-8 text-gray-700 dark:text-gray-300">A progressive draft format for Commander</p>
                
                <div class="hidden py-8 mt-16 border-y border-gray-100 dark:border-gray-800 sm:flex justify-between">
                    <div class="text-left">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Night 1</h6>
                        <p class="my-2 text-gray-200">Draft 3 packs from</p>
                        <ul class="text-gray-400">
                            <li>Commander Legends</li>
                        </ul>
                    </div>
                    <div class="text-left">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Nights 2-9</h6>
                        <p class="my-2 text-gray-200">Draft 1 pack each game from</p>
                        <ul class="text-gray-400">
                            <li>Dominaria Remastered</li>
                    ...
                    <div class="text-left">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Night 10</h6>
                        <p class="my-2 text-gray-200">Final Draft</p>
                        <ul class="text-gray-400">
                            <li>Commander Masters</li>
                        </ul>
                    </div>
                </div>
            </div>
